...
A pocket bank of age-appropriate baby activities that learns what actually works for your bub. One self-contained HTML file; installable as an offline app; every byte of data stays on your device.

**Use it here:** https://kilovd.github.io/baby-time/
...
Everything lives in your browser's local storage. Nothing is sent anywhere, ever. Export/import a JSON backup from Settings.

## Install

Open the app in Chrome → menu (⋮) → **Install app** (Android) or the install icon in the address bar (desktop). Works fully offline after the first load.

## Licence

Personal project by Daniel Kilov. Feel free to use it with your own bub.
